<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li {{isset($type_menu) && $type_menu == 'product' ? 'active' : ''}}><a href="{{route('admin_list_product')}}"><i class="fa fa-product-hunt"></i> <span>Danh sách sản phẩm</span></a></li>
            <li {{isset($type_menu) && $type_menu == 'product' ? 'active' : ''}}><a href="{{route('admin_list_service')}}"><i class="fa fa-book"></i> <span>Danh sách dịch vụ</span></a></li>
